...
<body>
    ...
    <div class="container">
        ...
        <br><br><br>
        <div class="card">
            <h5 class="card-header bg-success"> Top 8 sản phẩm có giá cao nhất</h5>
            <div class="card-body">
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($list as $index => $bk)
                            <tr>
                                ...
                                <td><a href="{{ route('book.show', ['id' => $bk->id]) }}" class="btn btn-success">Chi
                                        tiết</a>
                                </td>
                            </tr>
                        @endforeach
        ...
        <br><br>
        <div class="card">
            <h5 class="card-header bg-warning"> Top 8 sản phẩm có giá thấp nhất</h5>
            <div class="card-body">
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($lists as $index => $bks)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>{{ $bks->title }}</td>
                                <td><img src="{{ $bks->thumbnail }}" alt="" width="50px" height="50px"></td>
                                <td>{{ $bks->author }}</td>
                                <td>{{ $bks->publisher }}</td>
                                <td>{{ $bks->Publication }}</td>
                                <td>{{ $bks->Price }}</td>
                                <td>{{ $bks->Quantity }}</td>
                                <td>{{ $bks->categoty_name }}</td>
                                <td><a href="{{ route('book.show', ['id' => $bk->id]) }}" class="btn btn-success">Chi
                                        tiết</a>
                            </tr>
                        @endforeach
